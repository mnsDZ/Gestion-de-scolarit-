...
<li>
<a href="suppression.php"> <i class="menu-icon fa fa-pencil"style="color:#e74c3c;"></i><h5 style="color:#e74c3c;">Supprimer</h5> </a>
</li>
...
?>
                        <tr>
                            ...
                            <td>
                            <a href="suppression.php?num_inscription=<?php echo $row["num_inscription"];?>"><button type="button" class="btn btn-outline-danger fa fa-trash btn-lg" ></button></a>
                            <?php
                                }           
                             if ($_GET){
                                    $id = $_GET['num_inscription'];
                                    $sql = "DELETE FROM etudiant WHERE num_inscription =  ".$id;
